...
| **Integration** | `Neo4jPetAdapter` | Integración con Neo4j (Testcontainers) para verificar que la excepción se arroje y que la mascota quede correctamente vinculada al refugio (`LOCATED_IN`). |
